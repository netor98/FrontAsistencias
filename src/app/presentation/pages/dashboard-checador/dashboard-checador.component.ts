...
@Component({
  selector: 'app-dashboard-checador',
  imports: [FormsModule, CommonModule, RouterOutlet, RouterLink, RouterLinkActive],
  templateUrl: './dashboard-checador.component.html',
  styleUrl: './dashboard-checador.component.css'
})
export class DashboardChecadorComponent implements OnInit {
